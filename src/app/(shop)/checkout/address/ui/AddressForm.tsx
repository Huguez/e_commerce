...
export const AddressForm = () => {
   const { handleSubmit, register, formState: { touchedFields,  isValid } }  = useForm<InputsForm>() //leer base de datos
   ...
   return (
      <form className="grid grid-cols-1 gap-2 sm:gap-5 sm:grid-cols-2">
         ...
         <div className="flex flex-col mb-2 sm:mt-10">
            <button className={`${ isValid ? "btn-primary" : "btn-disabled" }  flex w-full sm:w-1/2 justify-center`} type='submit' disabled={ !isValid } >
               Next Step
            </button>
         </div>
